...
//          .setSummary(SmsMmsPreferenceFragment.getSummary(getActivity()));
    ...
    private void setCategoryVisibility() {
      Preference smsMmsPreference = this.findPreference(PREFERENCE_CATEGORY_SMS_MMS);
      if(smsMmsPreference != null) {
        getPreferenceScreen().removePreference(smsMmsPreference);
      }

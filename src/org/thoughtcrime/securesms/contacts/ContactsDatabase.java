...
public class ContactsDatabase {
  ...
  private static final String CONTACT_MIMETYPE = "vnd.android.cursor.item/vnd.id.kita.pesan.secure.contact";
  private static final String CALL_MIMETYPE    = "vnd.android.cursor.item/vnd.id.kita.pesan.secure.call";
  private static final String SYNC             = "__PK";
...
//        addContactVoiceSupport(operations, currentContactEntry.getKey(), currentContactEntry.getValue().getId());
  ...
  @NonNull Cursor queryTextSecureContacts(String filter) {
    ...
    return new ProjectionMappingCursor(cursor, projectionMap,
                                       new Pair<String, Object>(LABEL_COLUMN, "XecureChat"),
